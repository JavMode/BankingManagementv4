...
public class CardsApiDelegateImpl implements CardsApiDelegate {
    ...
    @Override
    public ResponseEntity<CardOperationResponse> withdraw(CardOperationRequest cardOperationRequest) {
        CardOperationResponse cardOperationResponse = mapper
                .stringToCardOperationResponse(cardService.deposit(cardOperationRequest));
